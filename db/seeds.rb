agent = User.where(email: 'rramos.moodhack@gmail.com').first_or_create({ email: 'rramos.moodhack@gmail.com', password: 'changeme', password_confirmation: 'changeme' })
agent.agent = true
agent.save!

agent = User.where(email: 'ctorrealba.moodhack@gmail.com').first_or_create({ email: 'ctorrealba.moodhack@gmail.com', password: 'changeme', password_confirmation: 'changeme' })
agent.agent = true
agent.save!

agent = User.where(email: 'jfuentes.moodhack@gmail.com').first_or_create({ email: 'jfuentes.moodhack@gmail.com', password: 'changeme', password_confirmation: 'changeme' })
agent.agent = true
agent.save!
